...
int main() {
    ...
    while(T--) {
        ...
        // Somewhat unintuitively, it is actually guaranteed that each number we divide N by is prime
        // If we look carefully, we notice that every factor of 30 is composed of primes (fundamental theorem of arithmetic)
        ...
        // As we are essentially eliminating the prime factors in increasing order, the last prime factor will be the largest
